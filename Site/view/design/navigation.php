            ...
            <div id="menu-part2">
              <?php if (is_a($_SESSION['utilisateur'],"Candidat")) : ?> <!-- CANDIDAT -->
                ...
                <?php if ($_SESSION['utilisateur']->getEtape()>=0) : ?>
                  <li><a href="../controler/recrutement-candidat.ctrl.php"><i class="fa fa-level-up" aria-hidden="true"></i>Mon Recrutement<?php $tt = $_SESSION['utilisateur']->getId(); echo "$tt"; ?></a></li>
                <?php endif; ?>
