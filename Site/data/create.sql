...
CREATE TABLE UTILISATEUR (
	idUtilisateur INTEGER NOT NULL PRIMARY KEY, -- identifiant unique de l'utilisateur
...
CREATE TABLE ENTREPRISE (
	idEntreprise INTEGER NOT NULL PRIMARY KEY, -- identifiant unique de l'entreprise
...
CREATE TABLE CANDIDAT (
	...
	lienLettreMotivation VARCHAR NULL, -- lien vers la lettre de motivation du candidat
	etape INTEGER CHECK (0 <= etape AND etape >= 4) DEFAULT 0, -- étape du recrutement du candidat
	pays VARCHAR NULL, -- pays où vit le candidat
	ville VARCHAR NULL, -- ville où vit le candidat
	idCompetence INTEGER NOT NULL, -- compétences du candidat
	idRenseignement INTEGER NOT NULL, -- préfrérences du candidat enregistrées dans la table RENSEIGNEMENT
...
CREATE TABLE COACH (
	...
	lienPhoto VARCHAR NOT NULL, -- lien vers la photo de profile du coach
